...
<div class="home">
    ...
    <div class="home-banner mb-block">
		...
		<? $slider = get_field("home_slider", $id); ?>
        <div class="home__slider">
            <div class="swiper slider-big ">
                <div class="swiper-wrapper">
					<? foreach ($slider as $cat) : ?>
                        <div class="swiper-slide">
                            <a href="<?= ($cat['slider_link']) ? $cat['slider_link']["url"]
								: '#'; ?>" class="slider-big__link">
                                <picture>
                                    <source media="(max-width: 767px)" srcset="<?= $cat['slider_mobile']["url"]; ?>">
                                    <img src="<?= $cat['slider_desktop']["url"]; ?>" alt="<?= $cat['slider_desktop']["alt"]; ?>" title="<?= $cat['slider_desktop']["title"]; ?>">
                                </picture>
                            </a>
                        </div>
					<? endforeach; ?>
                    ...
                    <div class="home-pallet__inner">
						<? foreach ($pallet as $cat) : ?>
                            <div class="home-pallet__card">
                                <a href="<?= $cat["link"]; ?>" class="home-pallet__link-img">
