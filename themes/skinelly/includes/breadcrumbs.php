...
class Kama_Breadcrumbs {
	...
	static $args = array(
		...
		'title_patt'      => '<span class="kb_title breadcrumbs__span">%s</span>', // шаблон для последнего заголовка. Если включено: show_post_title или show_term_title
	...
	function get_crumbs( $sep, $l10n, $args ){
		...
		if(1){
			...
			elseif( $mark === 'schema.org' ) $mark = array(
				...
				'linkpatt'   => '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a class="breadcrumbs__link"  href="%s" itemprop="name">%s</a></span>',
				'sep_after'  => '',
			);
