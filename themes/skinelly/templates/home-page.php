        ...
        <div class="home-banner mb-block">
            ...
            <div class="home-banner__image">
                <a href="drug/skinelly-light/">
                    <img class="lozad" data-src="<? the_field("home_banner_img", $id); ?>" alt="">
                </a>

            </div>
            <div class="home-banner__image-mobile">
                <a href="drug/skinelly-light/">
                    <img class="lozad" data-src="<? the_field("home_banner_img_mobile", $id); ?>" alt="">
                </a>
            </div>
        </div>
